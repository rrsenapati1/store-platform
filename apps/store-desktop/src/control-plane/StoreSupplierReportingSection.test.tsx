...
describe('store supplier reporting section', () => {
  ...
  test('loads read-only supplier reporting', async () => {
    render(<StoreSupplierReportingSection accessToken="session-cashier" tenantId="tenant-acme" branchId="branch-1" />);
    ...
    expect(screen.getByText('Read-only supplier exposure and dispute posture for branch staff.')).toBeInTheDocument();
