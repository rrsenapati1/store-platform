...
from store_control_plane.release_gate_orchestration import run_release_gate


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the bounded Store V2 release gate and write a final orchestration report.")
    ...
    parser.add_argument("--release-owner", required=True, help="Release owner recorded in the evidence output.")
    parser.add_argument("--output-dir", required=True, help="Directory where the release-gate reports and evidence artifacts will be written.")
    ...
    parser.add_argument("--retain-evidence-offsite", action="store_true", help="Upload the published evidence pack to configured object storage.")
    parser.add_argument("--verify-retained-evidence", action="store_true", help="Download retained evidence back from object storage and verify it after retention.")
